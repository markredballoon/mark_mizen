...
<ul class="steps">
	...
	<li id="facebook-settings-block">
		...
		<select name="asg[sources][facebook][caption_1]" value="<?php echo esc_attr($source['caption_1']) ?>" data-value="model.caption_1">
			...
			<option value="name" <?php echo selected($source['caption_1'], 'name')?>><?php _e('Image description', 'asg')?></option>
		...
		<select name="asg[sources][facebook][caption_2]" value="<?php echo esc_attr($source['caption_2']) ?>" data-value="model.caption_2">
			...
			<option value="name" <?php echo selected($source['caption_2'], 'name')?>><?php _e('Image description', 'asg')?></option>
			<option value="place" <?php echo selected($source['caption_2'], 'place')?>><?php _e('Place', 'asg')?></option>
		...
		<div class="lightbox-options">
			<p>
				...
				<select name="asg[sources][facebook][lightbox_caption_1]">
					...
					<option value="name" <?php echo selected($source['lightbox_caption_1'], 'name')?>><?php _e('Image description', 'asg')?></option>
					<option value="place" <?php echo selected($source['lightbox_caption_1'], 'place')?>><?php _e('Place', 'asg')?></option>
			...
			<p>
				...
				<select name="asg[sources][facebook][lightbox_caption_2]">
					...
					<option value="name" <?php echo selected($source['lightbox_caption_2'], 'name')?>><?php _e('Image description', 'asg')?></option>
					<option value="place" <?php echo selected($source['lightbox_caption_2'], 'place')?>><?php _e('Place', 'asg')?></option>
