...
class ASG_Flickr_Source extends ASG_Http_Source {
	...
	function get_flickr_url($action, $key, $params = array()) {
		...
		return add_query_arg(urlencode_deep($params), 'https://ycpi.api.flickr.com/services/rest/');
	}
	...
	function fetch_raw_images2($page, $per_page, $options) {
		...
		if (is_wp_error($user_id))
			return $user_id;
		$extras = 'description,tags,owner_name,url_o,url_k,url_h,url_l,url_c,url_z,url_m,url_n,url_s,url_t';
